...
const ContextMenu = ({
    mode, contextRow, contextMenuPosition, setContextMenuPosition, setTxToSplit, apiRef, setTransactions, setSelectionModel,
}) => {
    ...
    const handleMergeTransaction = () => {
        ...
        if (setTransactions) {
            ...
            setSelectionModel({ type: 'include', ids: new Set([ mainTx.id ]) });
        } else {
